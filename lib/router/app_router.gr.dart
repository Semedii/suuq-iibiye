...
import 'package:suuq_iibiye/utils/enums/category_enum.dart' as _i9;
...
abstract class $AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    BusinessInformationRoute.name: (routeData) {
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i2.BusinessInformationPage(),
      );
    },
...
class BusinessInformationRoute extends _i8.PageRouteInfo<void> {
  const BusinessInformationRoute({List<_i8.PageRouteInfo>? children})
      : super(
...
class CategoryRoute extends _i8.PageRouteInfo<CategoryRouteArgs> {
  CategoryRoute({
    required _i9.Category category,
    _i10.Key? key,
